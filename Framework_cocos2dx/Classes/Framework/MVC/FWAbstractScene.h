...
class FWAbstractScene : public cocos2d::CCScene, public FWAbstractViewDelegate
{
public:
    FWAbstractScene();
    FWAbstractScene(FWAbstractModel * model);
    
    virtual ~FWAbstractScene();
...
#pragma mark - Create function
    ...
    CREATE_FUNC_ONE_PARAMETER(FWAbstractScene, FWAbstractModel*, model);
...
#pragma mark - Scene operation
     ...
     */
    void                        replaceScene(FWAbstractScene *scene, FWE_TRANSITION transitionId = FWE_TRANS_FADE);
    
    /**
     * Push scene with the transition to the scene stack.
     */
    void                        pushScene(FWAbstractScene *scene, FWE_TRANSITION transitionId = FWE_TRANS_FADE);
